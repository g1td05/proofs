...
class SurveyResourceTest {
	...
	void retrieveSpecificSurveyQuestion_404Scenario() throws Exception{
		RequestBuilder rb = MockMvcRequestBuilders.get( SPECIFIC_QUESTION_URL ).accept( MediaType.APPLICATION_JSON );
	...
	void retrieveSpecificSurveyQuestion_basicScenario() throws Exception {
		...
		Question question = new Question( "Question1", "Most Popular Cloud Platform", Arrays.asList( "AWS", "Azure", "GCP" ), "AWS" );
